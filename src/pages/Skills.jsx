...
import nextJS from "../assets/logo-icons/nextjs.png";
...
const Skills = () => {
  ...
  return (
    <div name="skills" className="min-h-screen hero pt-16 flex items-center">
      <div className="mx-auto flex flex-col justify-center items-center">
        ...
        >
          ...
          <p className="font-primary text-sm mb-8 sm:mb-4 md:mb-8 lg:mb-12">
        ...
        >
          {skillSet.map((skill) => (
            <div
              key={skill.id}
              className={`shadow-md hover:scale-110 duration-500 py-1 lg:py-2 px-2 lg:px-4 rounded-xl ${skill.style}`}
            >
